 ...
 *
 * WHAT THIS DEPLOYS:
 *   1. ZybraGroupFactoryV2 - Factory for creating ROSCA groups
 *
 ...
 *
 * FEE ARCHITECTURE:
 *   ZybraGroupV2.collectFees() is permissionless and sends accumulated
...
contract DeployMainnet is Script {
    ...
    function run() external {
        ...
        console.log("   src/ZybraGroupFactoryV2.sol:ZybraGroupFactoryV2");
        console.log("");
    }
}
