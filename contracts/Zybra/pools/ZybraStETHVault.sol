...
import "./base/ZybraEUSDVaultBase.sol";

interface Ilido {
    function submit(address _referral) external payable returns (uint256 StETH);
}

contract ZybraStETHVault is ZybraEUSDVaultBase {
    ...
    constructor(address _stETH, address _oracle, address _config) ZybraEUSDVaultBase(_stETH, _oracle, _config) {
    }
